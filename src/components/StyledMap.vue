...
<script lang="ts">
  ...
  const endpoint = 'https://tiles.stadiamaps.com/tiles/stamen-toner/{z}/{x}/{y}{r}.png'
  ...
  const attribution = '&copy; <a href="https://stadiamaps.com/" target="_blank">Stadia Maps</a>, &copy; <a href="https://openmaptiles.org/" target="_blank">OpenMapTiles</a> &copy; <a href="https://www.openstreetmap.org/about" target="_blank">OpenStreetMap</a> contributors'
